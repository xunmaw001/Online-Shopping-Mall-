      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="总计" prop="zongji">
          <el-input v-model="ruleForm.zongji" 
              placeholder="总计" clearable  :readonly="ro.zongji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="总计" prop="zongji">
              <el-input v-model="ruleForm.zongji" 
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="申请原因" prop="shenqingyuanyin">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shenqingyuanyin" label="申请原因" prop="shenqingyuanyin">
                    <span v-html="ruleForm.shenqingyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.shenqingyuanyin = this.ruleForm.shenqingyuanyin.replace(reg,'../../../ssm2855h/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shouhou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shouhouCrossAddOrUpdateFlag = false;
                  this.parent.search();
