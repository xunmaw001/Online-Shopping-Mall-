<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="投诉标题" prop="tousubiaoti">
          <el-input v-model="ruleForm.tousubiaoti" 
              placeholder="投诉标题" clearable  :readonly="ro.tousubiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="投诉标题" prop="tousubiaoti">
              <el-input v-model="ruleForm.tousubiaoti" 
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="投诉日期" prop="tousuriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tousuriqi" label="投诉日期" prop="tousuriqi">
              <el-input v-model="ruleForm.tousuriqi" 
                placeholder="投诉日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="投诉内容" prop="tousuneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.tousuneirong" label="投诉内容" prop="tousuneirong">
                    <span>{{ruleForm.tousuneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.tousuriqi = this.getCurDateTime()
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shouji = true;
          ...
          if(o=='tousubiaoti'){
            this.ruleForm.tousubiaoti = obj[o];
	    this.ro.tousubiaoti = true;
            continue;
          }
          if(o=='tupian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `jubaotousu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.jubaotousuCrossAddOrUpdateFlag = false;
                  this.parent.search();
